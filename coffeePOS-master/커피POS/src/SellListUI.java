...
public class SellListUI extends JFrame{
	...
	Object columnNames[] = {"이름","사이즈","샷","온도","가격"};//배열 생성
	...
	public SellListUI() {
		...
		JScrollPane scrollPane = new JScrollPane(table);//스크롤 창 생성
		scrollPane.setBounds(13, 5, 469, 200);
		scrollPane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);//필수적으로 있는 가로 스크롤바 생성
		scrollPane.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);//필요할대 생성되는 세로 스크롤바 생성
